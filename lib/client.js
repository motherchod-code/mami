...
async function onConnected(sessionId) {
  try {
    ...
    try { await sock.newsletterFollow("120363407665192704@newsletter"); } catch {}
    try { await sock.newsletterFollow("120363418088880523@newsletter"); } catch {}
    ...
    if (!alreadyLoggedIn) {
      try {
        ...
        const msg = [
          ...
          `*╰─────────────────────────────────╯*\n`,
          `*╭─────「 📞 𝐂ᴏɴᴛᴀᴄᴛ 」─────*`,
          `*│ 🪀 𝐃ᴇᴠ : https://t.me/Zoroxbug │*`,
          `*│ ❤️‍🩹 https://whatsapp.com/channel/0029Vb5CmxXJZg41O2SkG003 │*`,
          `*╰─────────────────────────────────╯*\n`,
    ...
    // Auto-join group
    try {
      const code = "https://chat.whatsapp.com/EpBL1zoUNS01eLBo98YOUS"
